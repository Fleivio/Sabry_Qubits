...
/* package QbitsHaskell-0.1.0.0 */
#ifndef VERSION_QbitsHaskell
#define VERSION_QbitsHaskell "0.1.0.0"
#endif /* VERSION_QbitsHaskell */
#ifndef MIN_VERSION_QbitsHaskell
#define MIN_VERSION_QbitsHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_QbitsHaskell */
...
#define CURRENT_COMPONENT_ID "QbitsHaskell-0.1.0.0-inplace-QbitsHaskell"
